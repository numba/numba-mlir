// RUN: level_zero_runner %s -e main -entry-point-result=void -shared-libs=%mlir_wrappers_dir/%shlibprefixmlir_c_runner_utils%shlibext -shared-libs=%mlir_wrappers_dir/%shlibprefixmlir_runner_utils%shlibext -shared-libs=%numba_runtime_dir/%shlibprefixnumba-mlir-runtime%shlibext -shared-libs=%numba_igpu_runtime_dir/%shlibprefixnumba-mlir-gpu-runtime%shlibext | FileCheck %s
