...
func.func @test(%arg1: i64) -> tuple<i64> {
  %0 = numba_util.build_tuple %arg1 : i64 -> tuple<i64>
  return %0 : tuple<i64>
}
...
func.func @test() -> tuple<index, i64> {
  %0 = numba_util.env_region "test" -> tuple<index, i64> {
    %1 = "test.test"() : () -> tuple<index, i64>
    numba_util.env_region_yield %1: tuple<index, i64>
  }
...
//       CHECK: %[[RES:.*]]:2 = numba_util.env_region "test" -> index, i64 {
//       CHECK: %[[TUP:.*]] = "test.test"() : () -> tuple<index, i64>
//       CHECK: %[[E1:.*]] = numba_util.tuple_extract %[[TUP]] : tuple<index, i64>, %[[C0]] -> index
//       CHECK: %[[E2:.*]] = numba_util.tuple_extract %[[TUP]] : tuple<index, i64>, %[[C1]] -> i64
//       CHECK: numba_util.env_region_yield %[[E1]], %[[E2]] : index, i64
//       CHECK: }
