// RUN: numba-mlir-opt %s -pass-pipeline='builtin.module(func.func(ntensor-alias-analysis,ntensor-to-linalg))' --split-input-file | FileCheck %s
...
//  CHECK-NEXT:   %[[D1:.*]] = arith.constant 2 : index
//  CHECK-NEXT:   %[[D2:.*]] = arith.constant 3 : index
//  CHECK-NEXT:   %[[RES:.*]] = numba_util.env_region "test" -> !ntensor.ntensor<?x?xf32, "test"> {
...
//  CHECK-NEXT:   numba_util.env_region_yield %[[RES2]] : !ntensor.ntensor<?x?xf32, "test">
//  CHECK-NEXT:   }
...
//  CHECK-NEXT:   %[[D2:.*]] = arith.constant 3 : index
//  CHECK-NEXT:   %[[VAL:.*]] = arith.constant 5 : i32
//  CHECK-NEXT:   %[[RES:.*]] = numba_util.env_region "test" -> !ntensor.ntensor<?x?xi32, "test"> {
...
//  CHECK-NEXT:   numba_util.env_region_yield %[[RES3]] : !ntensor.ntensor<?x?xi32, "test">
//  CHECK-NEXT:   }
//  CHECK-NEXT:   return %[[RES]]
...
//  CHECK-NEXT:   numba_util.env_region_yield %[[RES]] : !ntensor.ntensor<?x5xf32, "test">
//  CHECK-NEXT:   }
...
// CHECK-LABEL: func @test
//  CHECK-SAME:   (%[[ARG1:.*]]: f32, %[[ARG2:.*]]: f32, %[[ARG3:.*]]: f32)
//  CHECK-NEXT:   %[[RES:.*]] = numba_util.env_region "test" -> !ntensor.ntensor<3xf32, "test"> {
...
//  CHECK-NEXT:   numba_util.env_region_yield %[[RES2]] : !ntensor.ntensor<3xf32, "test">
//  CHECK-NEXT:   }
...
//  CHECK-NEXT:   numba_util.env_region_yield %[[T3]] : !ntensor.ntensor<?x?xf32, "test">
//  CHECK-NEXT:   }
...
//  CHECK-NEXT:   numba_util.env_region_yield %[[D]] : index
//  CHECK-NEXT:   }
//  CHECK-NEXT:   return %[[RES]] : index
...
//       CHECK:   }
//       CHECK:   %[[RES1:.*]] = numba_util.enforce_shape %[[SRC1D2]] : tensor<?x?xf32>(%{{.*}}, %{{.*}}) -> tensor<?x?xf32>
...
//       CHECK:   }
//       CHECK:   %[[RES3:.*]] = numba_util.enforce_shape %[[SRC2D2]] : tensor<?x?xf32>(%{{.*}}, %{{.*}}) -> tensor<?x?xf32>
...
//       CHECK:   }
//       CHECK:   %[[RES3:.*]] = numba_util.enforce_shape %[[SRC2D1]] : tensor<?xf32>(%{{.*}}) -> tensor<?xf32>
...
//       CHECK:   numba_util.env_region_yield %[[RES2]], %[[RES4]] : !ntensor.ntensor<?x?xf32, "test">, !ntensor.ntensor<?x?xf32, "test">
